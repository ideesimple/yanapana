class Spree::Cause < ActiveRecord::Base
  ...
  has_many :products
  attr_accessible :description, :goal_facebook, :goal_money, :goal_twitter, :link_facebook, :link_pinterest, :link_twitter, :photo, :status, :title, :video, :artist_id, :organization_id, :date_start, :date_finish, :number_goal, :status, :inspiration, :sharephoto, :titleshare, :time_zone
