...
ActiveRecord::Schema.define(:version => 20130819163600) do
  ...
  create_table "spree_artists", :force => true do |t|
    t.string   "name"
    t.string   "last_name"
    t.text     "address"
  ...
  create_table "spree_causes", :force => true do |t|
    ...
    t.text     "inspiration"
    t.string   "sharephoto_file_name"
    t.string   "sharephoto_content_type"
    t.integer  "sharephoto_file_size"
    t.datetime "sharephoto_updated_at"
    t.string   "titleshare"
    t.string   "time_zone"
    t.integer  "goal_pinterest"
  end
